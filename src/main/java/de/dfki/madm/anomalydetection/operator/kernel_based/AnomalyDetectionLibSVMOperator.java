...
public class AnomalyDetectionLibSVMOperator extends
	...
	/**
	 * The parameter name for &quot;One-class SVM for unsupervised anomaly detection: one-class, robust one-class and
	 * eta one-class&quot;
	 */
	...
	/**
	 * The parameter name for &quot;Automatic tuning of gamma parameter using the heuristics defined in Evangelista, P.
	 * F., Embrechts, M. J., & Szymanski, B. K. (2007). Some Properties of the Gaussian Kernel for One Class Learning,
	 * 4668, 269--278.,&quot;
	 */
	...
	/**
	 * The parameter name for &quot;The parameter nu for one-class svm. It represents the lower bound on the number of
	 * support vectors and the upper bound on the number of outliers.&quot;
	 */
	public static final String PARAMETER_NU = "nu";

	/**
	 * The parameter name for &quot;The parameter lambda for robust one-class SVM.&quot;
	 */
	public static final String PARAMETER_LAMBDA = "lambda";

	/**
	 * The parameter name for &quot;The parameter beta for eta one-class SVM. It represents the ratio of expected
	 * outliers that will be not considered when training the SVM.&quot;
	 */
	...
	/**
	 * Values to allow logging the number of bound and non-bound support vectors
	 */
