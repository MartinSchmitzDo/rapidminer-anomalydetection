...
public class AnomalyDetectionLibSVMEvaluator implements Evaluator {
	...
	/**
	 * Anomaly Score is calculated according to the value of the decision function where it is normalized the maximum
	 * confidence. score(i) = maxConfidence - d(i)/ Math.abs(maxConfidence)
	 *
	 * @param model
	 * @param trainingSet
	 * @param testSet
